...
# Render the texts that you want to display and set text color
...
# setting center for the first text (distance from the left, distance from the top)
textRect1.center = (250, 250)

# distance of top-adge and left-edge of the center of the text are 250, 250
# setting center for the second text (distance from the left, distance from the top)
