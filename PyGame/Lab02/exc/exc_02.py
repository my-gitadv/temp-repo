# Create a function to draw flower
# example: flower.jpeg

# two options to draw petals and leaves:1. use rectangle // youredead
#                           2. use polygon  // youresurvive
import pygame
...
def cornerLeaf(x,y,size):
	...
	x3, y3 = x + 2*size , y - size * 5 + size
	x4, y4 = x + size/2 + size/2, y - size * 5 + size
